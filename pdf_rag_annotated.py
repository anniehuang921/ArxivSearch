...
# 🔢 嵌入模型工廠：建立 OpenAI 或 HuggingFace 的向量模型
...
def main() -> None:
    ...
    # task_goal="Search for top 5 papers published in the past 3 months about carbon inventory or carbon footprint accounting using AI."
    #task_goal = "Search and download for top 2 papers published in the past 3 months about carbon inventory or carbon footprint accounting using AI."
    task_goal = "Search the top 3 papers published in the past 3 months about GHG emission using AI."
